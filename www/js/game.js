class Game {
    ...
    loop() {
        ...
        // ৩. গেম আপডেট (ফিজিক্স, ইনপুট)
        if(!this.paused) this.update();

        // ৪. ক্যামেরা প্রয়োগ (Transform) - এখানে ctx সেভ করছি
        ctx.save(); 
        this.camera.apply(ctx);

        // ৫. ফ্লিপ ট্র্যাপ প্রয়োগ (যদি সক্রিয় থাকে)
        if(this.flipped) {
            ctx.save();
        ...
        // ৬. সবকিছু আঁকা (Render)
        this.render(ctx);

        // ৭. ফ্লিপ ও ক্যামেরা রিস্টোর করা (এটাই আগে ছিল না, তাই সবকিছু উধাও হয়ে যাচ্ছিল!)
        if(this.flipped) ctx.restore();
        ctx.restore(); // <-- ক্যামেরা ট্রান্সফর্ম রিসেট
